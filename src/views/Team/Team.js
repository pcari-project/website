            ...
            <Grid.Column>
                <Modal trigger={
                    ...
                    <Modal.Description>
                        ...
                        <p>Dr. Steve holds a PhD in Civil Engineering from University of Texas at Austin, MSc degree in Civil Engineering and BSc degree in Civil Engineering from University of Texas at Austin, and BA degree in Philosophy from Clark University at Worcester, Massachusetts.</p>
                    </Modal.Description>
                    </Modal.Content>
                </Modal>
            </Grid.Column>
            ...
            <Grid.Column>
                <Modal trigger={
                    ...
                    <Modal.Description>
                        ...
                        <p style={{marginTop:'1em'}}>Dr. Arthur L. Fajardo is the Project Staff for the pilot-testing of the wireless sensor network (WSN) technology in drip-irrigated upland crop production systems. </p>
            ...
            <Grid.Column>
                <Modal trigger={
                    ...
                    <Modal.Description>
                        ...
                        <p style={{marginTop:'1em'}}>Engr. Jeffrey is the Project Staff who supervises and facilitates pilot-testing of the wireless sensor network (WSN) Technology in lowland rice production systems with alternate wetting and drying technology.</p>
                        ...
                        <p>Engr. Jeffrey holds a MSc degree in Agricultural Engineering Major in Land and Water Resources Engineering and BSc degree in Agricultural Engineering Major in Agricultural Machinery, both from University of the Philippines Los Baños. When he graduated with his Bachelor's degree in 2011, he has been awarded the CEAT Best Thesis Award for his thesis “Design, Fabrication and Fabricationb of a Prototype Backyard-scale Aquaponics System.”</p>
                    </Modal.Description>
                    </Modal.Content>
                </Modal>
            </Grid.Column>
            ...
            <Grid.Column>
                <Modal trigger={
                    ...
                    <Modal.Description>
                        ...
                        <p>Engr. Kristelle holds a BSc degree in Agricultural Engineering Major in Land and Water Resources Engineering from University of the Philippines Los Baños. Currently, she is studying MSc degree in Agricultural Engineering Major in Land and Water Resources Engineering in the same university. </p>
            ...
            <Grid.Column>
                <Modal trigger={
                    ...
                    <Modal.Description>
                        ...
                        <p>In April 2016, he has been awarded the 2nd Best Poster Paper Presenter in the Soil, Water, and Aquaculture category for his poster, "Design, Development, and Calibration of an Arduino-based Soil Moisture Monitoring System" in the 13th International Agricultural Engineering Conference and Exhibition, 27th Philippine Agricultural Engineering Week, and 66th PSAE Annual National Convention held in Mariano Marcos State University, Batac, Ilocos Norte.</p>
                    </Modal.Description>
                    </Modal.Content>
                </Modal>
            </Grid.Column>
            ...
            <Grid.Column>
                <Modal trigger={
                    ...
                    <Modal.Description>
                        ...
                        <p>Engr. Ruzzel holds a BSc degree in Agricultural Engineering Major in Land and Water Resources Engineering from University of the Philippines Los Baños.</p>
                    </Modal.Description>
                    </Modal.Content>
                </Modal>
            </Grid.Column>
